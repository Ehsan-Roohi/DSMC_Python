...
def test_weighted_scatter_conserves_momentum_energy():
...
def test_physical_cavity_runs_and_collides():
...
def test_conservative_reallocation_and_budget():
    cfg = PhysicalCavityConfig(
        nx=4,
        ny=4,
        particles_per_cell=8,
...
def test_cell_weight_equalization_conserves_invariants():
    from vgdsmc.sbt_solver import equalize_cell_weights
