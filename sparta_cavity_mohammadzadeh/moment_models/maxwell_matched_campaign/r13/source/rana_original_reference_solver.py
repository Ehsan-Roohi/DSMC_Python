...
STATE_ORDER = (
    ...
    "R_yy",
    "m_xxx",
    # Executable A/X-matrix order: A[7,13]=1 identifies m_xxy, while the
    # x-wall m_ssn condition occupies slot 14.  The isolated state list below
    # Eq. (11) swaps these two labels.
    "m_xxy",
    "m_xyy",
    "m_yyy",
    "Delta",
...
def build_result(
    ...
    *,
    ...
    model_name = "R13 Maxwell-production validation candidate"
    ...
    result: dict[str, object] = {
        ...
        "collision_model": "Maxwell molecules",
        "viscosity_law": "mu/mu0 = theta/theta0",
        "production_prefactor": "rho/Kn_Rana",
        "external_validation_status": "not completed",
        "configuration": asdict(config),
        "formulation": "appendix-A-coefficient Maxwell-production candidate",
        "solver": solver,
        "metrics": metrics,
...
def run(
    ...
    *,
    ...
    maxwell_path = source_path.with_name("r13_maxwell_production.py")
    source_hash_start = sha256_file(source_path)
    coefficient_hash_start = sha256_file(coefficient_path)
    maxwell_hash_start = sha256_file(maxwell_path)
    ...
    result["execution_provenance"] = {
        **privacy_checks,
        ...
        "maxwell_production_source": maxwell_path.name,
        "maxwell_production_sha256_at_start": maxwell_hash_start,
        "maxwell_production_sha256_at_end": maxwell_hash_end,
