#!/usr/bin/env python3
"""Private source-locked R26 Rana/John continuation on stretched grids.
...
small optimizer norm to model validation.  The exact John Kn values are
entered on the Gu mean-free-path basis and mapped to Rana's viscosity basis
outside this script: 0.1*sqrt(2/pi)=0.07978845608 and
0.5*sqrt(2/pi)=0.3989422804.
"""
...
from r26_cases import SQRT_2_OVER_PI, gu_asme2009_cavity_case, rana_john_case
...
def main() -> None:
    ...
    parser.add_argument(
        "--case-family",
        choices=("rana-john2010", "gu-asme2009"),
        default="rana-john2010",
        help=(
            "Rana-viscosity-basis John comparison or direct source-locked "
            "Gu ASME mean-free-path case"
        ),
    )
    ...
    if args.case_family == "rana-john2010":
