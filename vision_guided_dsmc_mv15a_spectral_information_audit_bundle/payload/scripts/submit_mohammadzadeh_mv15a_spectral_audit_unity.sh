...
PYTHONPATH="${PROJECT_ROOT}:${PYTHONPATH:-}" \
  "${MV10_VENV_DIR}/bin/python" -m vgdsmc.mohammadzadeh_mv15a_spectral_information_audit \
...
EXPORTS="ALL,MV15A_PROJECT_ROOT=${PROJECT_ROOT},MV15A_PAYLOAD_ROOT=${PAYLOAD_ROOT},MV15A_OUTPUT_ROOT=${OUTPUT_ROOT},MV15A_MV9_OUTPUT_ROOT=${MV10_MV9_OUTPUT_ROOT},MV15A_MV14_OUTPUT_ROOT=${MV14_OUTPUT_ROOT},MV15A_VENV_DIR=${MV10_VENV_DIR},MV15A_BATCH_SIZE=${MV15A_BATCH_SIZE:-8}"
